...
Esta ferramenta é utilizada pelo Tcpreplay (tcprewrite) para fragmentar pacotes (opção `--fragroute=conf.cfg` do tcprewrite).
...
- fragroute_1.2-8ubuntu20.04_amd64.deb - **Pacote do Kali Linux adaptado para o Ubuntu 20.04**
